...
<script type="text/javascript">
    ...
    function CreateMapByLocation() {
        ...
        updateLatPosition(latLng);
        updateLngPosition(latLng);
        ...
        infoWindow.setContent("<?php echo ($siswa['alamat_latitude'] != '' && $siswa['alamat_longitude'] != '') ? $siswa['alamat'] : 'Surabaya '; ?>");
        infoWindow.open(map, marker);

    }

    function CreateMapByAddr(geocode_result) {
                ...
                <form class="form-horizontal form-validation"  method="post" style="width: 90%">
                    <fieldset>
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8 validate[required]" name="nama" value="<?php echo $siswa['nama_siswa'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span2 datepicker validate[required]" name="tgl_lahir" value="<?php echo $siswa['tgl_lahir'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8" name="nama_ortu" value="<?php echo $siswa['nama_ortu'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8" name="pekerjaan_ortu" value="<?php echo $siswa['pekerjaan_ortu'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <textarea name="kekhususan" style="resize: none;height:80px" class="validate[required] span6"><?php echo $siswa['kekhususan'] ?></textarea>
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <textarea name="alamat" id="alamat"  style="resize: none;height:80px" class="span6"><?php echo $siswa['alamat'] ?></textarea>
                                <div class="alert" style="margin: 10px 0px">
                                    <i><strong>Sekedar Info</strong> Untuk mempermudah pencarian alamat dalam map gunakan format alamat seperti contoh : <br/> "Jalan Margorejo 7a, Surabaya" atau "Pucang Anom Timur, Surabaya"</i>
                                </div>
                            </div> <!-- /controls -->	
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="lat" name="lat" style="background-color:#b0b6bd;" readonly="true" value="<?php echo $siswa['alamat_latitude'] ?>"/>
                                <input type="text" id="longi" name="long" style="background-color:#b0b6bd;" readonly="true" value="<?php echo $siswa['alamat_longitude'] ?>"/>
                                <div id="mapCanvas" style="margin: 20px 0px"></div>
                                <script>
        ...
        $('#show_on_map').click(function() {
            $.getJSON("https://maps.googleapis.com/maps/api/geocode/json?address=" + $('#alamat').val(), function(data) {
                if (!$.isEmptyObject(data.results)) {
                    ...
                    $('#mapCanvas').show();
                    CreateMapByAddr(geocode_result);
                } else {
