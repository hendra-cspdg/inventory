...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Data<small>Material</small></h2>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control col-md-4 col-xs-12 validate[required]"name="kode_barang" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control col-md-4 col-xs-12 validate[required]"name="nama_barang" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control col-md-4 col-xs-12 "name="merk" value="">
                                            </div>
                                        </div>
                    ...
                    <tbody>
                        ...
                        foreach ($data_barang as $d):
                            ...
                            <tr>
                                ...
                                <td><?php echo $d['nama_barang'] ?> / <?php echo $d['nama_satuan'] ?></td>
                                ...
                                <td style="width: 150px;text-align: center">
                                    <div>
                                        <button id="button-modal-barang-edit-<?php echo $d['id_barang'] ?>" data-target="#modal-barang-edit-<?php echo $d['id_barang'] ?>" role="button" class="btn btn-default" data-toggle="modal"><i class="fa fa-edit"></i> </button>
                                        <div id="modal-barang-edit-<?php echo $d['id_barang'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="barangLabel" data-id="<?php echo $d['id_barang'] ?>" aria-hidden="true">
                                            <div class="modal-dialog">
                        ...
                        <script>
                            $(document).ready(function() {
                                $('#button-modal-barang-edit-<?php echo $d['id_barang'] ?>').click(function() {
                                    $.ajax({
                                        url: '<?php echo Yii::app()->createUrl('master/barang/updateAjax?id=' . $d['id_barang']); ?>',
