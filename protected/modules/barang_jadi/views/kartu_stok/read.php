                    ...
                    <tbody>
                        ...
                        foreach ($data_barang as $d):
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-default  btn-sm" title="Detail" href="<?php echo Yii::app()->createUrl('laporan/kartu_stok/detail?id=' . $d['id_barang'].'&s='.$sisa); ?>"><i class="fa fa-list-alt"></i></a>
                                </td>
                            </tr>
                            <?php
                        endforeach;
