...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Data<small>Barang Jadi</small></h2>
                ...
                <table id="barang-table" class="table table-striped responsive-utilities jambo_table">
                    ...
                    <tbody>
                        ...
                        foreach ($data_barang as $d):
							...
							$sisa=$d['total_barang']-$d['total_ambil']
                            ?>
                            <tr>
                                ...
                                <td><?php echo $des ?></td>
                                <td><?php echo number_format($d['total_barang']) ?></td>
								<td><?php echo number_format($d['total_ambil']) ?></td>
								<td><?php echo number_format($sisa) ?></td>
                                <td>
                                    <a class="btn btn-default  btn-sm" title="Detail" href="<?php echo Yii::app()->createUrl('barang_jadi/data/detail?id=' . $d['id_barang_jadi'] . '&s='.$sisa); ?>"><i class="fa fa-list-alt"></i></a>
                                </td>
                            </tr>
                            <?php
                        endforeach;
