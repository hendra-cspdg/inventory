        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <form class="form-inline form-validation"  method="get" >
                    ...
                    <input type="hidden" name="id" value="<?php echo $id_barang_jadi ?>"/>
                    <input type="text" name="s" value="<?php echo $stok ?>"/>
                ...
                <table class="table table-striped" style="width: 50%">
                    ...
                    <tbody>
                        ...
                        if (count($deskripsi) > 0) {
                            ...
                            $des = $barang_jadi['deskripsi'];
                        }
                        ?>
                        <tr>
                            <td>Nama Barang</td>
                            <td><?php echo $barang_jadi['nama_barang_jadi'] ?></td>
                        </tr>
                        <tr>
                            <td>Satuan</td>
                            <td><?php echo $barang_jadi['nama_satuan'] ?></td>
                        </tr>
                        <tr>
                            <td>Deskripsi</td>
                            <td><?php echo $des ?></td>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table style="width: 80%" class="table  table-bordered">
                    ...
                    <tfoot>
                        <tr class="active">
                            <td colspan="4"><b>JUMLAH STOK AKHIR</b></td>
                            <td class="text-right"><?php echo $saldo ?></td>
                        </tr>
                    </tfoot>
                </table>
                ...
                <form class="form-horizontal form-validation"  method="post" >
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <a class="btn btn-primary" title="Edit" href="<?php echo Yii::app()->createUrl('laporan/barang_jadi/read'); ?>">Kembali</a>
                            <a class="btn btn-dark" target="_blank" title="Cetak" href="<?php echo Yii::app()->createUrl('laporan/barang_jadi/cetak?' . Yii::app()->request->queryString); ?>"><i class="fa fa-print"></i> Cetak</a>
                        </div>
                    </div>
