        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-validation"  method="post" >
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_proyek">Pilih Proyek
                        </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <a href="#" class="editable_field form-control" data-disabled="true"   data-source="<?php echo Yii::app()->createUrl('AjaxData/getJSONProyek'); ?>" data-value="<?php echo $permintaan_barang['id_proyek'] != '' ? $permintaan_barang['id_proyek'] : ''; ?>" data-name="id_proyek" data-type="select"  data-title="Input data"></a>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tgl_on_site">TGL On Site
                        </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <a href="#" class="editable_field form-control" data-disabled="true"   data-name="tgl_on_site" data-type="date" data-title="Input data"><?php echo $permintaan_barang['tgl_on_site'] ?></a>
                        </div>
                    </div>
                    <div class="form-group">
