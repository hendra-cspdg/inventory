...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Data<small>Permintaan Bahan Baku</small></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <p><a href="<?php echo Yii::app()->createUrl('permintaan_barang/baru/create'); ?>" class="btn btn-default"><i class="fa fa-plus"></i>&nbsp;&nbsp;Buat Baru</a></p>
                <hr/>
                        ...
                        foreach ($data as $d):
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a class="btn btn-dark btn-sm" target="_blank" title="Cetak" href="<?php echo Yii::app()->createUrl('permintaan_barang/baru/cetak?id=' . $d['id_permintaan_barang']); ?>"><i class="fa fa-print"></i> CETAK</a>
                                </td>
                                    ...
                                    <div>
                                        ...
                                        if ($d['id_peg_apv'] == '') {
                                            ...
                                            <form method="post" class="delete-permintaan-barang" style="display: inline">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $d['id_permintaan_barang'] ?>"/>
