            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-validation"  method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <a href="#" class="editable_field form-control" data-name="nomor_permintaan" data-type="text"  data-title="Input data"><?php echo $permintaan_barang['nomor_permintaan'] ?></a>
                        </div>
                    </div>
                    <div class="form-group">
