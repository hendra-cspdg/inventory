    ...
    <fieldset>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <select id="barang-<?php echo $pbd['id_permintaan_barang_detail'] ?>" name="barang" class="form-control js-data-example-ajax" style="width: 98%" data-placeholder="Pilih Barang..."  tabindex="99">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <input type="text" readonly="" id="satuan-<?php echo $pbd['id_permintaan_barang_detail'] ?>" class="form-control col-md-4 col-xs-12 validate[required]"name="satuan_barang" value="" tabindex="99">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <input type="number" id="jumlah" class="form-control col-md-4 col-xs-12 validate[required]"name="jumlah" value="<?php echo $pbd['jumlah_barang'] ?>">
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="modal-footer">
            ...
            <input type="hidden" name="id_bd" value="<?php echo $pbd['id_permintaan_barang_detail'] ?>"/>
...
<script>
    $(document).ready(function() {
        $('#barang-<?php echo $pbd['id_permintaan_barang_detail'] ?>').select2({
            ajax: {
        ...
        $('#barang-<?php echo $pbd['id_permintaan_barang_detail'] ?>').change(function() {
            $.ajax({
                url: '<?php echo Yii::app()->createUrl('ajaxData/getSatuanBarang'); ?>',
                data: 'id=' + $(this).val(),
                success: function(respones) {
                    $('#satuan-<?php echo $pbd['id_permintaan_barang_detail'] ?>').val(respones);
                }
            })
        });
