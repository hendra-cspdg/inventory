        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-validation"  method="post" >
					...
					<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="jumlah_barang">Jumlah Barang<span class="required">*</span>
                        </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <a href="#" class="editable_field form-control" data-name="jumlah_barang" data-type="text"  data-title="Input data"></a>
                        </div>
                    </div>
                    <div class="form-group">
