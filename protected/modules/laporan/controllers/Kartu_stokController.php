...
class Kartu_stokController extends Controller {
    ...
    public function actionRead() {
        $query_barang = "
            select b.id_barang,b.kode_barang,b.nama_barang,b.deskripsi,s.nama_satuan, ttd.total_terima, pbd.total_ambil
            from barang b
            left join (
