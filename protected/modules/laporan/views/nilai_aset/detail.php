                ...
                <form class="form-horizontal form-validation"  method="post" >
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <a class="btn btn-primary" title="Edit" href="<?php echo Yii::app()->createUrl('laporan/nilai_aset/read'); ?>">Kembali</a>
                            <a class="btn btn-dark" target="_blank" title="Cetak" href="<?php echo Yii::app()->createUrl('laporan/nilai_aset/cetak?' . Yii::app()->request->queryString); ?>"><i class="fa fa-print"></i> Cetak</a>
                        </div>
                    </div>
