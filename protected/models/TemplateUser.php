 ...
 * @property string $id_template_user
...
class TemplateUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_user, id_template, id_parent, status_aktif', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_template_user, id_user, id_template, id_parent, status_aktif', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_template_user',$this->id_template_user,true);
		$criteria->compare('id_user',$this->id_user,true);
		$criteria->compare('id_template',$this->id_template,true);
                $criteria->compare('id_template',$this->id_parent,true);
