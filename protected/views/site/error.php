...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo Yii::app()->baseUrl; ?>/fonts/css/font-awesome.min.css" rel="stylesheet">
    ...
    <body class="nav-md">
                ...
                <div class="col-md-12">
                    <div class="col-middle">
                        <div class="text-center text-center">
                            <h1 class="error-number"><?php echo $error['code']; ?></h1>
                            <h2>Error : <?php echo $error['type']; ?></h2>
                            <p> <?php echo $error['message']; ?>
                            </p>
                                    ...
                                    <div class="col-xs-12 form-group pull-right top_search">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <button onclick="window.location.href='<?php echo Yii::app()->homeUrl; ?>'" class="btn btn-default" type="button">Back</button>
                                            </span>
                                        </div>
                                    </div>
                                </form>
        ...
        <script src="<?php echo Yii::app()->baseUrl; ?>/js/progressbar/bootstrap-progressbar.min.js"></script>
        <script src="<?php echo Yii::app()->baseUrl; ?>/js/nicescroll/jquery.nicescroll.min.js"></script>
        <!-- icheck -->
        <script src="<?php echo Yii::app()->baseUrl; ?>/js/icheck/icheck.min.js"></script>
